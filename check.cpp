...
int check( int side )
    ...
    if( side > 0 )
        ...
        return pop_count(((attack_rotate_135[king][(board->rotate_135
            >> rotate_135_shift[king]) & rotate_135_mask[king]]
            | attack_rotate_45[king][(board->rotate_45 >> rotate_45_shift[king]) & rotate_45_mask[king]]) & (board->
            white_bishops
            | board->white_queens))
...
int attack( int side, int sq )
    ...
    if( side < 0 )
        ...
        return pop_count(((attack_rotate_135[sq][(board->rotate_135 >> rotate_135_shift[sq]) & rotate_135_mask[sq]]
            | attack_rotate_45[sq][(board->rotate_45 >> rotate_45_shift[sq]) & rotate_45_mask[sq]]) & (board->
            white_bishops
            | board->white_queens))
