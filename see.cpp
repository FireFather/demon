...
int see(int from_sq, const int to_sq)
{
	int score[32];
	...
	bitboard attack = ((attack_rotate_135[to_sq][(board->rotate_135 >> rotate_135_shift[to_sq]) & rotate_135_mask[to_sq]]
		| attack_rotate_45[to_sq][(board->rotate_45 >> rotate_45_shift[to_sq]) & rotate_45_mask[to_sq]]) & (board->white_bishops
